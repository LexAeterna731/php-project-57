...
return [
    'custom_required_field_error' => 'Это обязательное поле',
    'custom_unique_field_error' => 'Значение поля должно быть уникальным',
    'custom_max_field_error' => 'Значение поля слишком длинное',
    'custom_unique_task_status_error' => 'Статус с таким именем уже существует',
    'custom_unique_label_error' => 'Метка с таким именем уже существует',
    'custom_unique_task_error' => 'Задача с таким именем уже существует',
